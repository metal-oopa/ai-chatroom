...
Original file is located at
    https://colab.research.google.com/drive/1YkqSPuD8obZVW-niD3GuydH9UeEqtc0V
...
# !mkdir ~/.kaggle
# !cp CharacterLinesSteinsGateFIXED.csv ~/.kaggle/CharacterLinesSteinsGateFIXED.csv

# !kaggle datasets download ruolinzheng/twewy-game-script -f twewy-name-line-full.csv

data = pd.read_csv('./CharacterLinesSteinsGateFIXED.csv', sep="|",error_bad_lines=False)

data.sample(6)

len(data)

sum(data.name== "Rintaro")

CHARACTER_NAME = 'Rintaro'
...
for step in range(4):
    ...
    print("RintaroBot: {}".format(tokenizer.decode(chat_history_ids[:, bot_input_ids.shape[-1]:][0], skip_special_tokens=True)))

"""## Push Model to Hugging Face"""

# !sudo apt-get install git-lfs

# !git config --global user.email "sudip5banerjee1974@gmail.com"
# # Tip: using the same email as your huggingface.co account will link your commits to your profile
# !git config --global user.name "metaloopa"

# MY_MODEL_NAME = 'DialoGPT-medium-Rintaro'
